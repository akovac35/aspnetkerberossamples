...
APP_HOST=172.28.139.238 # Application host IP address
...
scp -i $APP_HOST_SSH_KEY ./bin/Release/net8.0/linux-x64/publish/*  $APP_HOST_SCP_USER@$APP_HOST:$APP_HOST_PATH
